...
- **Phase Completion & Branching Protocol:** Before moving to any new phase, you MUST commit all completed changes from the finished phase and checkout a dedicated feature branch for the upcoming phase (e.g. `git checkout -b phase-4-beneficiary-management`). Ensure `.agents/.handoff/` is cleaned up and all documentation (`PROJECT_ROADMAP.md`, `QA_CHECKLIST.md`, `DESIGN_SYSTEM.md`) is kept in sync.
