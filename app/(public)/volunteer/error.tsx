...
export default function VolunteerError({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 text-center">
      ...
      <button
        onClick={reset}
        className="px-4 py-2 text-sm font-semibold text-black bg-emerald-400 hover:bg-emerald-300 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-emerald-500"
      >
        Try again
      </button>
    </div>
