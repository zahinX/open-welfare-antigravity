...
export default function ShiftDetailError({
  ...
  return (
    <div className="p-6 md:p-8 max-w-4xl mx-auto flex flex-col items-center justify-center py-24">
      ...
      <p className="text-base font-semibold text-white mb-1">Could not load shift details</p>
      <p className="text-sm text-zinc-400 mb-6 text-center max-w-sm">
        {error.message || 'The shift may not exist or an unexpected error occurred.'}
      </p>
