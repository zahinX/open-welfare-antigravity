...
function SubmitButton({ isEdit }: { isEdit: boolean }) {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="inline-flex items-center gap-2 px-6 py-2.5 rounded-lg text-sm font-semibold text-black bg-emerald-400 hover:bg-emerald-300 disabled:opacity-60 disabled:cursor-not-allowed transition-colors"
    >
      {pending ? (
        <>
    ...
    <form action={formAction} className="space-y-6">
      ...
      <div className="space-y-1.5">
        ...
        <input
          ...
          className={`w-full px-4 py-2.5 rounded-lg bg-zinc-900 border text-white placeholder-zinc-600 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/50 transition-colors ${
            state?.fieldErrors?.title ? 'border-red-500' : 'border-zinc-800 hover:border-zinc-700'
          }`}
        />
      ...
      <div className="space-y-1.5">
        ...
        <textarea
          ...
          className={`w-full px-4 py-2.5 rounded-lg bg-zinc-900 border text-white placeholder-zinc-600 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/50 resize-y transition-colors ${
            state?.fieldErrors?.description ? 'border-red-500' : 'border-zinc-800 hover:border-zinc-700'
          }`}
        />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div className="space-y-1.5">
          <label htmlFor="target_amount" className="block text-sm font-medium text-zinc-300">
            Target Amount (৳)
          </label>
          <input
            id="target_amount"
            ...
            className={`w-full px-4 py-2.5 rounded-lg bg-zinc-900 border text-white text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/50 transition-colors ${
              state?.fieldErrors?.target_amount ? 'border-red-500' : 'border-zinc-800 hover:border-zinc-700'
            }`}
          />
        ...
        <div className="space-y-1.5">
          ...
          <select
            ...
            className="w-full px-4 py-2.5 rounded-lg bg-zinc-900 border border-zinc-800 hover:border-zinc-700 text-white text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/50 transition-colors"
          >
      ...
      {/* Deadline */}
      <div className="space-y-1.5">
        <label htmlFor="deadline_at" className="block text-sm font-medium text-zinc-300">
        ...
        <input
          ...
          className="w-full px-4 py-2.5 rounded-lg bg-zinc-900 border border-zinc-800 hover:border-zinc-700 text-white text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/50 transition-colors [color-scheme:dark]"
        />
